...
final class Version20260903062452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE classycash.messenger_messages (
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_CAFE4BC2FB7336F0E3BD61CE16BA31DBBF396750 ON classycash.messenger_messages (
              queue_name, available_at, delivered_at,
              id
            )
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE classycash.cache_items (
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE classycash.sessions (
        ...
        SQL);
        $this->addSql('CREATE INDEX sess_lifetime_idx ON classycash.sessions (sess_lifetime)');
        $this->addSql(<<<'SQL'
            ALTER TABLE
